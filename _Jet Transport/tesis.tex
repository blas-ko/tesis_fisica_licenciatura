...
\usepackage{caption}  
\captionsetup[figure]{margin=0.5cm,font=footnotesize,labelfont=bf}
...
%\usepackage{psfrag}             %para que texto en la figura sea remplazado
                                %incluso formulas
\usepackage[inner=2.cm,outer=1.5cm, top=4.cm, bottom=0cm]{geometry}
...
\newcommand{\titulo}{Búsquedas de oscilaciones de neutrinos en el experimento
MiniBooNE:\\ análisis de aparición de neutrinos y antineutrinos del
electrón}
\newcommand{\titulito}{Búsquedas de oscilaciones de neutrinos en el experimento
MiniBooNE: análisis de aparición de neutrinos y antineutrinos del electrón}
\newcommand{\nombre}{{\Large \textbf{\textsc{Iker Loic De Icaza Astiz}}}}
\newcommand{\carrera}{{\large \textsc{Físico}}}
\newcommand{\director}{{\large\textsc{Dr. Alexis Armando Aguilar Arévalo}}}
\newcommand{\fecha}{2013} 
...
\ifpdf
\usepackage[pdfauthor={De Icaza Astiz Iker Loic},%
pdftitle={\titulito},%
...
\newcommand{\arlia}{\begin{flushright} \includegraphics[width=18pt]{Imagenes/arlia.pdf}
  \end{flushright}} 

\newcommand{\arliaBW}{\begin{flushright} \includegraphics[width=18pt]{Imagenes/arlia-BW.pdf}
  \end{flushright}} 
...
\label{chap:jetT}
\input{Chapters/02_transporteJet}
...
\chapter{Modelación del Tokamak} 
\label{chap:toka}
\input{Chapters/03_tokamak}
