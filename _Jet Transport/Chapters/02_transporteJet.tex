...
%Construir la forma simpléctica para hamiltoniano y llegar a A^T w + w A = 0. Hacer notar que se puede constuir un simil para cualquier EDO y estuidar tantio esto. Esto se puede hacer con JT de orden 1. Probarlo en hamiltonianos y no hamiltonianos también! Se puede hacer un campo escalar de esto? 
