...
\label{eq:polprod}
\end{equation}
donde $ A \cdot B \ \in \pk$, o sea, un \textbf{polinomio truncado} a orden $n$ para que esté en el campo. Aún cuando las operaciones están definidas inspiradas en la aritmética de los números, $\mathbb{K}$ puede ser cualquier campo arbitrario.
