...
Hay que destacar que el TJ no sirve únicamente para dar indicadores dinámicos del espacio fase. Hay realmente muchas cosas que se pueden aprovechar al tener la solución parametrizada por polinomios. Entre éstas están hacer simulaciones de Montecarlo o hacer variación de los parámetros de las ecuaciones.
