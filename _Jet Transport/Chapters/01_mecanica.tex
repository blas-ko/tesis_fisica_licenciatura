...
\begin{align}
 ...
 \dot{v}_y &= \Omega^2 y \left( x - \frac{ R^3 (1 - \alpha) }{\left( (x+\alpha R)^2 + y^2 \right)^{3/2} } - \frac{ R^3 \alpha }{\left( (x - (1-\alpha) R)^2 + y^2 \right)^{3/2} } \right) - 2\Omega v_x
\end{align}
donde
\begin{align*}
...
La estabilidad de estos puede estudiarse viendo cómo se comportan las ecuaciones de primera variación alrededor de los puntos de equilibrio, sin embargo, las herramientas desarrolladas en esta tesis automatizan todo ese trabajo, por lo que dicho análisis se estudiará más a fondo en el capítulo \ref{sec:results} de resultados.
